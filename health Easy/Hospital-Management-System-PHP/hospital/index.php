    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:25px; margin-top: 1.7% !important;">Easy Health
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h2 class="animated bounceInDown">"your Health Is An <br>investmest,<br> Not An Expense"</h2>
                ...
                <div class="carousel-item active">
                    <img class="d-block w-100" src="assets/images/slider/slider_6.jpg" alt="Third slide">
                      <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <p class="animated bounceInDown">Choose the experts in end to end care.</p>
    ...
    <section id="about_us" class="about-us">
        <div class="row no-margin">
            ...
            <div class="col-sm-6 abut-yoiu">
                ...
                <p> The online healthcare system is intended for Any Medical clinic to supplant their current manual, paper based framework. The following data will be managed by the new system: patient data, room availability, staff and operating room schedules, and patient invoices. These administrations are to be given in a proficient, organised way, diminishing the time and assets right now expected for such undertakings.
The acquisition, management, and timely retrieval of large amounts of information are essential to the operation of any patient. Typically, this information includes; patient individual data and clinical history, staff data, staff planning, working performance center planning and different offices holding up records. This data should be all overseen in a productive and cost wise style with the goal that an establishments assets might be really used easy Health will mechanize the administration of the emergency clinic making it more proficient and mistake free. It aims to standardize the date, consolidate the data, guarantee the integrity of the data, and lessen inconsistencies. </p>
<?php
...
<p> Techno International New Town ,India<br>
Phone: 1122334455<br>
Email: Techno@gmail.com<br>
Timing: 9 am To 8 Pm </p>
<?php
